...
//3. data retrevial function will "fetch" the following data from the provided URL
    ...
    function clear() {
        document.querySelector('.pokemon_image').src = "assets\pokeball.jpg";
        document.getElementsByClassName('pokemon_name').value = "";
        document.getElementsByClassName('pokemon_id').value = "";
        document.getElementsByClassName('pokemon_type').value = "";
        document.getElementsByClassName('pokemon_abilities').value = "";
        document.getElementsByClassName('pokemon_moves').value = "";
    }